...
-- CreateEnum
CREATE TYPE "MeetingStatus" AS ENUM ('PENDING', 'UPLOADING', 'PROCESSING', 'TRANSCRIBING', 'ANALYZING', 'COMPLETED', 'FAILED');
...
-- CreateEnum
CREATE TYPE "NotifType" AS ENUM ('MEETING_READY', 'TASK_ASSIGNED', 'MEMBER_JOINED', 'SYSTEM');
